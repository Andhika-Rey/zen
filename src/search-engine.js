...
const searchData = [
  ...
  // Features
  {
    ...
    content: 'Tekan Cmd+K atau Ctrl+K untuk membuka Command Palette. Cari halaman, actions, atau navigasi cepat ke materi pembelajaran. Mendukung fuzzy search dan keyboard navigation.',
    url: '#',
    category: 'feature',
  ...
  },
  {
    ...
    content: 'Gunakan / untuk focus search, Ctrl+T untuk toggle theme, ? untuk help modal, Esc untuk close modals. Navigasi penuh tanpa mouse.',
    url: '#',
    category: 'feature',
